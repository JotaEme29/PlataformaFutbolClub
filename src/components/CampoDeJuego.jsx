...
function CampoDeJuego({ titulares = [], onJugadorClick, formacion, tiempoEnCampo, onDropPosition }) {
          ...
          return (
            ...
            >
              {jugador ? (
                ...
                <div className="posicion-vacia clickable" onClick={() => onJugadorClick && onJugadorClick(null)}></div>
              )}
            </div>
          );
        })}
